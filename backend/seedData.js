...
const samplePosts = [
  {
    ...
    description: "Organized a community tree planting event where we planted 25 native saplings including neem, mango, and gulmohar trees. Over 50 students participated and we're planning to make this a monthly event. The trees will help reduce air pollution and provide shade for future generations.",
  ...
  },
  {
    ...
    description: "Completed a week-long plastic waste collection challenge in my neighborhood. Collected 8kg of plastic bottles, bags, and packaging materials. Took everything to the local recycling center and documented the entire process. This helped clean up our area and raised awareness about plastic pollution.",
    category: "recycling",
  ...
  },
  {
    ...
    description: "Convinced my family to replace all 12 old incandescent bulbs with energy-efficient LED bulbs. This will save approximately 60% on our electricity bill and reduce our carbon footprint. Calculated that we'll save 240 kWh per year, equivalent to planting 2 trees!",
  ...
  },
  {
    ...
    description: "Implemented a rainwater harvesting system in our school garden using old plastic drums and PVC pipes. The system collects rainwater from the school roof and stores it for watering plants. This saves approximately 200 liters of water daily during the monsoon season.",
  ...
  },
  {
    ...
    description: "Started a community composting project in our apartment complex. We collect kitchen waste from 15 families and convert it into organic compost. The compost is used in our community garden and shared with local farmers. This reduces landfill waste and creates nutrient-rich soil.",
    category: "other",
...
async function seedDatabase() {
  try {
    ...
    insertedPosts.forEach((post, index) => {
      console.log(`${index + 1}. ${post.title} by ${post.author} (${post.ecoPoints} points)`);
    });
